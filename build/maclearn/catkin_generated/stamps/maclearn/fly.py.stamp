...
def fly():
    ...
    sub_arduino = message_filters.Subscriber('channel_values_time', PoseStamped)
    """
    ts = message_filters.ApproximateTimeSynchronizer([sub_vicon_pose, sub_vicon_twist,                sub_vicon_accel, sub_arduino], 10, 0.1, allow_headerless=True)
    """
