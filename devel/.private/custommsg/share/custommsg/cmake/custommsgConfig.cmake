...
if(NOT "/home/jasper/flap_ws/devel/.private/custommsg/include " STREQUAL " ")
  set(custommsg_INCLUDE_DIRS "")
  set(_include_dirs "/home/jasper/flap_ws/devel/.private/custommsg/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'custommsg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jasper/flap_ws/src/custommsg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jasper/flap_ws/devel/.private/custommsg/lib;/home/jasper/flap_ws/devel/lib;/home/jasper/birb_ws/devel/lib;/opt/ros/melodic/lib)
